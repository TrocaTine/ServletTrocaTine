...
<table>
    ...
    <%
        ...
        // Verifica se a lista de categorias não é nula e não está vazia
        if (categorias != null && !categorias.isEmpty()) {
            for (Categoria categoria : categorias) {
    %>
    <tr>
        <!-- Exibe os dados das categorias -->
    ...
    %>
    <!-- Caso não existam categorias, exibe mensagem informando -->
    <tr>
...
<!-- Botões de navegação para as operações de CRUD -->
